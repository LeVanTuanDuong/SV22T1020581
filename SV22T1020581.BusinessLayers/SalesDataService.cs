...
namespace SV22T1020581.BusinessLayers
{
    ...
    /// </summary>
    public static async Task<PagedResult<OrderViewInfo>> ListOrdersAsync(SV22T1020581.Models.Sales.OrderSearchInput input)
        {
        ...
        {
            return await orderDB.UpdateDetailAsync(data.OrderID, data.ProductID, data.Quantity, data.SalePrice);
        }

        /// <summary>
        /// Cập nhật mặt hàng trong đơn hàng (theo tham số riêng)
        /// </summary>
