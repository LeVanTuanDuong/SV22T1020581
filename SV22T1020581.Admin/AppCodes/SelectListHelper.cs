...
namespace SV22T1020581.Admin.AppCodes
{
    /// <summary>
    ...
    public static class SelectListHelper
    {
        ...
        /// <summary>
        /// Loại hàng (phiên bản có phân trang)
        /// </summary>
        /// <param name="input">Điều kiện tìm kiếm và phân trang.</param>
        /// <returns>Danh sách SelectListItem.</returns>
        public static async Task<List<SelectListItem>> Categories(PaginationSearchInput input)
        {
            var list = new List<SelectListItem>()
            {
                new SelectListItem() { Value = "0", Text = "-- Loại hàng --"}
